...
<body>
	...
	<div class="nav">
		<ul class="userMenu">
            ...
            <li class="current"><a class="menua" href="/index.php?m=admin&c=user&a=order" <?php if($type == 0): ?>style="display:none"<?php endif; ?>>查询</a></li>
			...
			<div class="lshow">
				...
				<form>
					<table>
						...
						<tbody>
						<?php if(is_array($order)): $i = 0; $__LIST__ = $order;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr>
